...
object MyProductSchema {
        ...
        const val ALTER_TABLE_BOOKMARKED_AT_VER_200 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN $COLUMN_BOOKMARKED_AT DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'"

        const val ALTER_TABLE_WAIT_FREE_EPISODE_COUNT_VER_211 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN $COLUMN_WAIT_FREE_EPISODE_COUNT INTEGER NOT NULL DEFAULT -1"

        const val ALTER_TABLE_WAIT_FREE_EPISODE_READ_COUNT_VER_211 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN $COLUMN_WAIT_FREE_EPISODE_READ_COUNT INTEGER NOT NULL DEFAULT -2"

        const val ALTER_TABLE_TICKET_TOTAL_COUNT_VER_250 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN $COLUMN_TICKET_TOTAL_COUNT INTEGER NOT NULL DEFAULT 0"

        const val ALTER_TABLE_NOW_FREE_NEXT_META_INFO_VER_380 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN $COLUMN_NOW_FREE_NEXT_META_INFO TEXT NOT NULL DEFAULT ''"

        const val ALTER_TABLE_NOW_FREE_NEXT_READ_AT_VER_380 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN now_free_next_read_at DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'"

        const val ALTER_TABLE_NOW_FREE_OPEN_STATUS_FINISH_DAYS_VER_380 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN $COLUMN_NOW_FREE_OPEN_STATUS_FINISH_DAYS INTEGER NOT NULL DEFAULT 0"

        const val ALTER_TABLE_LAST_PURCHASED_AT_VER_390 = "ALTER TABLE $MY_PRODUCT " +
                "ADD COLUMN $COLUMN_LAST_PURCHASED_AT DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'"
